...
PORT=20128
HOSTNAME=0.0.0.0
INTERNAL_URL=http://127.0.0.1:20128
PUBLIC_BASE_URL=http://127.0.0.1:20128
APP_URL=http://127.0.0.1:20128
DATA_DIR=/app/data
NODE_ENV=production
...
print_install_info() {
  ...
  case "$name" in
    ...
    axonhub)
      ...
      ;;
    9router)
      echo "  内网地址: http://127.0.0.1:20128"
      echo "  局域网地址: http://$ip:20128"
      echo "  环境文件: $dir/.env"
      if [ -f "$dir/.env" ]; then
