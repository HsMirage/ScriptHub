...
当前主要脚本是 `AI/ai-tools-manager.sh`，用于统一管理一组 AI 相关服务，例如 NewAPI、AxonHub、CLIProxyAPI、Sub2API、9Router、LiteLLM 和 PostgreSQL。
...
- Sub2API 使用独立 PostgreSQL 和 Redis，安装时会自动选择空闲端口并生成管理员及数据库安全凭据。
